...
def perform_tvla():
    random_file = '../results/aes_operation_opt_MODE128_10p0ns/tvla_dynamic/tvla_traces.out'
    fixed_file = '../results/aes_operation_opt_MODE128_10p0ns/tvla_static/tvla_traces.out'
    ...
    # This block runs both files at the exact same time
