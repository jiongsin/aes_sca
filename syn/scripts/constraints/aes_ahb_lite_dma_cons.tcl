...
# Timing and design-rule constraints for the AES AHB-Lite DMA top level.
# Defines the HCLK clock, I/O delays, drive/load assumptions, reset/clock ideal networks, net-fixing rules, and input/output path groups.
