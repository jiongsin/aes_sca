# Synthesis script for the AES AHB-Lite DMA side-channel-aware top level.
# Reads the AES DMA/CTR/operation/S-box RTL, applies timing and SCA preservation constraints, compiles the design, generates reports, and writes synthesis outputs.
