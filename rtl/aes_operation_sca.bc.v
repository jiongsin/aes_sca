...
Performance: /home/user16/aes_sca/syn/results/aes_operation_sca_MODE128_10p0ns/reports/qor.rpt
  Critical Path Clk Period : 10.0 ns
  Critical Path Slack      : 6.23 ns
  Maximum Frequency        : 265.25 MHz

Power: /home/user16/aes_sca/syn/results/aes_operation_sca_MODE128_10p0ns/reports/power.rpt
Total power                : 2388.4000 uW
  Dynamic power            : 1.8580e+03 uW (77.8%)
    Internal power         : 1536.3000 uW
    Switching power        : 321.7303 uW
  Static power             : 5.3035e+08 pW (22.2%)

Area: /home/user16/aes_sca/syn/results/aes_operation_sca_MODE128_10p0ns/reports/qor.rpt
  Design Area              : 26144.0480 (10.2871 kGE)
    Combinational Area     : 13741.566343 (52.6%)
    Noncombinational Area  : 12402.481673 (47.4%)
  Net Length               : 140110.88

*****************************************************************/
// Full DOM Masking generated from fullDOMshuff

// ============================================================================
// MAIN ACCELERATOR MODULE
// Features: Full Datapath Masking, Parallel Key Generation
// ============================================================================
module aes_operation_sca #(
    parameter MODE = 128
) (
    ...
    // ------------------------------------------------------------------------
    // SEQUENTIAL COLUMN LOGIC
    // ------------------------------------------------------------------------
    wire [1:0] cur_col_idx = 
        (cycle_cnt == 4'd1) ? 2'd0 :
        (cycle_cnt == 4'd2) ? 2'd1 :
        (cycle_cnt == 4'd3) ? 2'd2 :
        (cycle_cnt == 4'd4) ? 2'd3 : 2'd0;
            ...
            case (state)
                S_IDLE: begin
                    if (valid_in) begin
                        `ifndef AES_256
                        `ifndef AES_192
                        state_reg_0 <= {state_reg_0[95:0], data_in ^ initial_add_rk_word ^ random_bits[175:144]};
                        state_reg_1 <= {state_reg_1[95:0], random_bits[175:144]};
                        `endif
                        `endif
                        key_reg <= {key_reg[MODE-33:0], key_in};
                    end
...
Performance: /home/user16/aes_sca/syn/results/aes_operation_sca_MODE128_10p0ns/reports/qor.rpt
  Critical Path Clk Period : 10.0 ns
  Critical Path Slack      : 6.48 ns
  Maximum Frequency        : 284.09 MHz

Power: /home/user16/aes_sca/syn/results/aes_operation_sca_MODE128_10p0ns/reports/power.rpt
Total power                : 2355.1000 uW
  Dynamic power            : 1.8388e+03 uW (78.1%)
    Internal power         : 1557.4000 uW
    Switching power        : 281.3733 uW
  Static power             : 5.1634e+08 pW (21.9%)

Area: /home/user16/aes_sca/syn/results/aes_operation_sca_MODE128_10p0ns/reports/qor.rpt
  Design Area              : 25516.3123 (10.0401 kGE)
    Combinational Area     : 12762.603630 (50.0%)
    Noncombinational Area  : 12753.708687 (50.0%)
  Net Length               : 126845.64
